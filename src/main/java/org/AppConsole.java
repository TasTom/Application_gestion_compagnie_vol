...
public class AppConsole {
    ...
    private static void creerVol() {
        try {
            ...
            System.out.println("\nPilotes disponibles :");
            List<Pilote> pilotes = piloteDAO.readAll(); // Changé de readAll à findAll
            if (pilotes.isEmpty()) {
            ...
            System.out.println("\nAvions disponibles :");
            List<Avion> avions = avionDAO.readAll(); // Changé de readAll à findAll
            if (avions.isEmpty()) {
    ...
    private static void listerTousLesVols() {
        try {
            ...
            List<Vol> vols = volDAO.readAll(); // Changé de readAll à findAll
            if (vols.isEmpty()) {
